...
imagePath = 'C:\\Users\\HP\\3D Objects\\Datasets\\Datasets\\image2.png'
cascadeClassifierPath = 'C:\\Users\\HP\\3D Objects\\OLD_CODE\\FaceDetection\\haarcascade_frontalface_alt.xml'
...
try:
	...
	#CONSTRUCTING RECTANGLE AROUND THE FACE
	for(x,y, width, height) in detectedFaces:
		cv2.rectangle(image, (x, y), (x+width, y+height), (0,0,255), 10)
		
	cv2.imwrite('C:\\Users\\HP\\3D Objects\\Datasets\\Datasets\\result3.jpg', image)
